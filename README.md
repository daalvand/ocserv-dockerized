...
```bash
curl -O https://raw.githubusercontent.com/daalvand/ocserv-dockerized/master/ocserv-install.sh
```
...
```bash
docker build -t ocserv https://github.com/daalvand/ocserv-dockerized.git
```
